...
entities~\cite{ehtesham:survey2025}. We propose a unified ``Agent
...
\begin{itemize}
  ...
  \item \emph{Peer-Delegation (A2A/ACP):} High-level task handoff,
    ...
    between autonomous peers~\cite{ehtesham:survey2025}.
\end{itemize}
...
\begin{itemize}
  \item \textbf{Layer 3 --- Collaboration} (``The Social Layer''):
    ...
    goals (``Plan a trip'')~\cite{ehtesham:survey2025}.
...
\begin{itemize}
  ...
  \item \textbf{Ecosystem Maturity:} While MCP has rapid adoption
    ...
    lacks~\cite{ehtesham:survey2025}.
